# David Chen — Head of Model Risk Engineering

> Ground truth / model risk

## Notes
<!-- Date-stamped meeting notes. Newest on top. -->

### 2026-09-17 — Snowflake Risk & Data Governance Discussion with Bank's Risk/Data Team
_Moved here from `cro-notes.md` — this is David Chen's Model Risk / Risk-Data Engineering meeting (Speaker 3 = Bank Risk/Data leader with the $1.8M budget, manager of Elena Torres), not the CRO meeting._
...
- Speaker 3 (Bank Risk/Data leader — David Chen / his team; has $1.8M budget; manager of Elena Torres)
...
## Follow-ups
- [ ] Confirm Speaker 3's exact title/name maps to David Chen (Head of Model Risk Engineering) vs a direct report.
- [ ] Reconcile the $1.8M/Q2 budget (this team) vs Sarah's £2–3M ring-fenced remediation (CRO) — two distinct budgets.
- [ ] Deliver the working lineage/governance demo before end-Q2 budget expiry.
